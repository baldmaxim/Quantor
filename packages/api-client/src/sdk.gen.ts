...
/**
 * Синтетические сценарии MEP-эксперимента
 */
export const listMepScenarios = <ThrowOnError extends boolean = false>(options?: Options<ListMepScenariosData, ThrowOnError>): RequestResult<ListMepScenariosResponses, unknown, ThrowOnError> => (options?.client ?? client).get<ListMepScenariosResponses, unknown, ThrowOnError>({ url: '/api/v1/mep/experiment/scenarios', ...options });

/**
 * Сценарий MEP-эксперимента: evidence, сеть РД и физический ВОР
 */
export const getMepScenario = <ThrowOnError extends boolean = false>(options: Options<GetMepScenarioData, ThrowOnError>): RequestResult<GetMepScenarioResponses, GetMepScenarioErrors, ThrowOnError> => (options.client ?? client).get<GetMepScenarioResponses, GetMepScenarioErrors, ThrowOnError>({ url: '/api/v1/mep/experiment/scenarios/{scenario_id}', ...options });
