 ...
 */
export const exportSheetTakeoff = <ThrowOnError extends boolean = false>(options: Options<ExportSheetTakeoffData, ThrowOnError>): RequestResult<ExportSheetTakeoffResponses, ExportSheetTakeoffErrors, ThrowOnError> => (options.client ?? client).get<ExportSheetTakeoffResponses, ExportSheetTakeoffErrors, ThrowOnError>({ url: '/api/v1/sheets/{sheet_id}/takeoff-export.csv', ...options });
