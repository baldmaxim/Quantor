...
export const ToolButton = ({
  ...
  <button
    ...
    className={cx(
      'grid h-[var(--h-ctl-ws)] place-items-center rounded-[var(--radius-sm)] transition-colors',
      wide ? 'flex items-center gap-[var(--s-3)] px-[var(--s-4)] text-xs' : 'w-[30px]',
...
export const ToolField = ({
  ...
  <span className="flex items-center gap-[var(--s-2)] text-xs text-muted" aria-label={label}>
