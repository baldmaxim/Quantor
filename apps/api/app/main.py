...
DESCRIPTION = (
    "API портала автоматизированного подсчёта строительных объёмов: проекты, импорт "
    "распознанных пакетов, просмотрщик документации и ручной обмер с детерминированным "
    "расчётом величин. Вызовов моделей в API нет: AI-геометрия Stage 2B — офлайн-лаборатория."
)
