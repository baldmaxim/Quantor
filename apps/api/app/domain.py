...
# отвергать переросший запрос **до** разбора: многоугольник в сто тысяч вершин, дошедший
# до проверки в сервисе, уже оплачен памятью и временем.
#
# Числа с запасом к наблюдаемому: контур этажа на архитектурном плане — это сотни вершин,
