...
- /health/ready — БД и объектное хранилище доступны (для балансировщика и локальной диагностики).
...
ComponentState = Literal["ok", "unavailable"]
...
async def readiness(response: Response) -> ReadinessResponse:
    ...
    return ReadinessResponse(status="ok" if healthy else "degraded", components=list(components))
