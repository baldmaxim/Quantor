...
| v2    | плиты на сборке v2: `dataset verify`, дымовой DINOv2, U-Net v2 — шаги в [10, § 10](10-slab-small-baseline.md)               | `.venv-train`   | вывод verify, время и память дымового, `metrics.json` U-Net |
