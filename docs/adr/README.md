...
| [0020](0020-napravlenie-stage-2b-ai-geometry-lab.md)                          | Направление Stage 2B: AI Geometry Lab вместо Auto Count                  | принято |
| [0021](0021-oflajn-eksperiment-ne-proizvodstvennaya-vozmozhnost.md)           | Офлайн-эксперимент не является производственной возможностью             | принято |
| [0022](0022-kandidat-predskazaniya-otdelyon-ot-izmereniya.md)                 | Кандидат предсказания отделён от принятого измерения                     | принято |
| [0023](0023-pilotnyj-flag-zakryvaet-vozmozhnost-na-servere.md)                | Пилотный флаг закрывает возможность и в интерфейсе, и на сервере         | принято |
| [0024](0024-masshtabirovanie-prosmotrshchika-po-zameru.md)                    | Масштабирование просмотрщика: слои по области, индекс, тайлы — по замеру | принято |
| [0025](0025-rastr-lista-po-vidimoj-chasti-i-sloi-bez-pokadrovoj-otrisovki.md) | Растр листа по видимой части и слои без покадровой перерисовки           | принято |
